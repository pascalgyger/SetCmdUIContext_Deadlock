...
namespace VSIXProject4
{
    ...
    {
        /// <summary>
        /// VSIXProject4Package GUID string.
        /// </summary>
        public const string PackageGuidString = "51b91bcc-a22a-4efd-a699-47b3e68f5923";
        ...
        public async Task SetCustomContextAsync(AsyncPackage package, bool enable)
        {
            ...
            int setContextResult = svc.SetCmdUIContext(cookie, enable ? 1 : 0);
